function [rgb_test_decs_arr, dep_test_decs_arr, out_iter] = main_co_LRESVM_DA(rgb_pos_ftr,rgb_neg_ftr,dep_pos_ftr,dep_neg_ftr,rgb_L,dep_L,rgb_M,dep_M,rgb_test_ftr,dep_test_ftr,param)
...
for out_iter = 1:param.OUT_MAX_ITER
    ...
    t_start = tic;
    [rgb_Z, dep_Z, obj1_par] = update_Z_DA_by_ADM(rgb_G, dep_G, param);
    ...
    param.w_flag = 'rgb';
    t_start = tic;
    [rgb_W, rgb_G, obj2_rgb] = update_W_DA_LRESVM(rgb_Z, rgb_G, rgb_pos_ftr, rgb_neg_ftr, rgb_L, rgb_M, param);
    fprintf('finish RGB W time: %f s\n', toc(t_start));
    fprintf('Update depth W....\n');
    param.w_flag = 'dep';
    t_start = tic;
    [dep_W, dep_G, obj2_dep] = update_W_DA_LRESVM(dep_Z, dep_G, dep_pos_ftr, dep_neg_ftr, dep_L, dep_M, param);
