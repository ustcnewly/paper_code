...
%      save('non_convex_QP_debug.mat',  '-v7.3');
      
    if sw_Newton_Schur
        warning off
        d_mu = S\(-H*x-c+A'*(mu./g)); 
%         save('non_convex_QP_debug.mat', 'H', 'S', 'x', 'c', 'A', 'mu', 'g', 'd_mu', '-v7.3');
        solve_this = solve_this+1;
        warning on
...
%         save('non_convex_QP_debug.mat', 'zeta_mu', 'solu_mu', '-v7.3');
        Delta_z_mu = zeta_mu-z;
    end
