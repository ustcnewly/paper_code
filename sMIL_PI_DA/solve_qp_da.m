function model = solve_qp_da(K, tK, Kss, Kst, y, p, svm_C1, svm_C2, gamma1, gamma2, B, epsilon, pos_bn, neg_fn)
...
lb      = zeros(3*n, 1);
ub      = [Inf(pos_bn,1);ones(neg_fn,1);Inf(n,1);Inf(n,1)];  % a_neg<c_star, set c_star=1 here
