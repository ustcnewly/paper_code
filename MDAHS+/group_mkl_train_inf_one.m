function [alpha, mu, obj, history] = group_mkl_train_inf_one(K, index, y_set,cost_vec, opt )
%
%
%   mu = \min_{mu} J(mu)
%
...
wnorm_sum_m = sum(wnorm.^2, 1).^(1/2);
for t = 1 : T
    for m = 1 : M
        new_mu(m,t) = wnorm_sum_m(t);
    end
end

new_mu = new_mu./ sum(wnorm_sum_m);
