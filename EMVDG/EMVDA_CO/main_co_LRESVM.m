function output_decs_arr = main_co_LRESVM(pos_ftr, neg_ftr, L_arr, M_arr, test_ftr, param)
...
for out_iter = 1:param.OUT_MAX_ITER
    ...
    for fti = 1:param.feat_type_num
        ...
        t_start = tic;
        [W_arr{fti}, G_arr{fti}, obj2_arr(fti)] = update_W_LRESVM(Z_arr{fti}, G_arr{fti}, pos_ftr{fti}, neg_ftr{fti}, L_arr{fti}, M_arr{fti}, param);
