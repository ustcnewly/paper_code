function [A,alpha_mat,d,obj] = update_A(kernel_arr, d, B, param)
    ...
    ub = param.C*ones(param.neg_num+1,1);
    ...
    for ii = 1:param.pos_num  
        ...
        if param.year==2012       
            ...
            A(:,ii) = solve_QP_SMO_allQ_14(Q_all, p, lb, ub, init_derive, init_alpha, ii, param.pos_num, param.smo_max_iter, param.smo_eps_obj, param.smo_quiet_mode);      
        end
