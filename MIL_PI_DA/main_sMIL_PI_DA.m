function model = main_sMIL_PI_DA(K, tK, Kss,Kst, pos_bags, neg_bags, param)
...
bag_model   = train_sMIL_PI_DA(K, tK, Kss, Kst, labels, p, svm_C1, svm_C2, gamma1, gamma2, B, epsilon, pos_bn, neg_fn);
